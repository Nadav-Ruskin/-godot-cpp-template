...
void TrafficLight::_bind_methods() {
	// ClassDB::bind_method(D_METHOD("set_me_texture", "texture"), &TrafficLight::set_me_texture);
	// ClassDB::bind_method(D_METHOD("get_me_texture"), &TrafficLight::get_me_texture);
...
// void TrafficLight::set_me_texture(const Ref<Texture2D> &p_texture) {
// 	me_texture = p_texture;
// }

// Ref<Texture2D> TrafficLight::get_me_texture() const {
// 	return me_texture;
// }
